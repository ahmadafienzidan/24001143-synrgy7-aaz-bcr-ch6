...
router.get("/cars", authenticate, carsController.getAllCars.bind(carsController));
...
router.delete("/cars/:id", authenticate, authorize(["admin", "superadmin"]), carsController.softDeleteCar.bind(carsController));
router.delete("/cars/permanent/:id", authenticate, authorize(["admin", "superadmin"]), carsController.deleteCarPermanently.bind(carsController));
